...
## Getting Started
Download the source code zip file and extract it.  You can compile and run this program any way you choose: the command line, an IDE like Eclipse or IntelliJ, or an online IDE like Mimir or Codio (if you have access to one).  Some students find it useful to print out a [grammar refernece sheet](./grammar_reference.pdf) which contains all the grammars for this project in a concise format, but this information is also contained in this writeup.
